  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-card via-background to-muted opacity-50"></div>
      ...
      <section id="testimonials" className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              See how SalonPro has transformed businesses just like yours.
            </p>
          </div>
            ...
            {[
              {
                ...
                content:
                  "SalonPro transformed how we operate. Our booking efficiency increased by 40% and client satisfaction is at an all-time high.",
                rating: 5,
              },
              {
                name: "Michael Chen",
