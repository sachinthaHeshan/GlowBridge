...
import { Plus, Edit, Trash2, Clock, DollarSign, Package, ArrowLeft } from "lucide-react"
...
const mockCategories = [
  { id: "1", name: "Hair Services", description: "Professional hair cutting, styling, and treatment services" },
  { id: "2", name: "Nail Services", description: "Complete nail care including manicures and pedicures" },
  { id: "3", name: "Spa Services", description: "Relaxing spa treatments and wellness services" },
  { id: "4", name: "Beauty Services", description: "Makeup, skincare, and beauty enhancement services" },
]
...
export default function CategoryServicesPage() {
  ...
  useEffect(() => {
    ...
    const categoryServices = mockServices.filter((service) => service.categoryId === categoryId)
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-600">Showing {filteredServices.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200/50">
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-blue-700">Private Services</p>
                <p className="text-2xl font-bold text-blue-800">{filteredServices.filter((s) => s.isPrivate).length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {filteredServices.length === 0 && (
        <Card className="p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Try adjusting your search filters or create a new service for this category.
          </p>
        </Card>
      )}
